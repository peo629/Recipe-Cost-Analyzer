      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Overview of your recipe costs and margins.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-card">
          ...
          <CardContent>
            <div
              ...
              data-testid="stat-total-recipes"
            >
              {stats.totalRecipes}
            </div>
          </CardContent>
        ...
        <Card className="bg-card">
          ...
          <CardContent>
            <div
              className="text-3xl font-bold"
              data-testid="stat-total-ingredients"
            >
        ...
        <Card className="bg-card">
          ...
          <CardContent>
            <div className="text-3xl font-bold" data-testid="stat-avg-cost">
              {formatCurrency(stats.avgCostPerPortion)}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-primary/20">
          ...
          <CardContent>
            ...
            >
              {formatCurrency(stats.avgRecommendedSalePrice)}
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        {stats.recentRecipes.length === 0 ? (
          <div className="bg-muted/30 border border-dashed rounded-xl p-12 text-center">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm mx-auto">
              Get started by building your first recipe. Track your costs and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {stats.recentRecipes.map((recipe) => (
              <Link key={recipe.id} href={`/recipes/${recipe.id}`}>
                <Card
                  className="hover:border-primary/50 transition-colors cursor-pointer group h-full flex flex-col"
